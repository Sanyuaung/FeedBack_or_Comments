            ...
            <div
                ...
                <div class="mt-5 flex justify-center">
                    <a target="_blank" href="https://portfolio.sanyuaung.dev/" style="color: #39ff14;"
                        class="inline-flex font-serif text-white bg-green-500 border-0  font-bold py-2 px-6 rounded-full focus:outline-none hover:bg-green-700 rounded text-lg">My
                        Portfolio
                    </a>
                    <a href="{{ route('create') }}" style="color: #39ff14;"
                        class="font-serif ml-4 inline-flex text-white bg-green-500 border-0  font-bold py-2 px-6 rounded-full focus:outline-none hover:bg-green-700 rounded text-lg">Go
